...
export function MetalButton({
  ...
  const sharedClasses = cn(
    "inline-flex items-center justify-center gap-2 rounded-full font-bold font-['Rajdhani',sans-serif] tracking-wide transition-[transform,background-color] duration-200 ease-out",
    "text-neutral-900 hover:opacity-80 active:scale-[0.97] dark:text-white",
    "focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-60 cursor-pointer",
    SIZE[size],
    className,
  );

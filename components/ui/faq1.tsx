    ...
    <section id="faq" className="w-full bg-white dark:bg-slate-950 transition-colors">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mb-12 text-center">
          <p className="mb-3 text-xs sm:text-sm font-bold tracking-widest uppercase text-[#FF4625] dark:text-orange-400 font-['Orbitron',sans-serif]">
            FAQ
          </p>

          <h2 className="mb-4 text-3xl sm:text-4xl md:text-5xl font-black tracking-wider text-slate-900 dark:text-white font-['Orbitron',sans-serif]">
            Frequently Asked Questions
          </h2>

          <p className="mx-auto max-w-xl text-base sm:text-xl text-slate-600 dark:text-slate-400 leading-relaxed font-semibold font-['Rajdhani',sans-serif] tracking-wide">
        ...
        >
          {faqs.map((faq, index) => (
            ...
            >
              <AccordionTrigger className="text-left text-base sm:text-lg font-bold text-slate-900 dark:text-white py-4 sm:py-5 hover:text-[#FF4625] dark:hover:text-orange-400 transition-colors font-['Orbitron',sans-serif] tracking-wide">
                {faq.question}
              </AccordionTrigger>

              <AccordionContent className="text-slate-600 dark:text-slate-400 text-sm sm:text-base leading-relaxed pb-5 pt-1 font-medium font-['Rajdhani',sans-serif] text-[15px] sm:text-lg">
                {faq.answer}
              </AccordionContent>
            </AccordionItem>
          ))}
